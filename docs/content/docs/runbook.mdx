...
## Step 7: Configure Providers and Create a Config

To use the LLM gateway:

1. Go to **Settings** → **Workspace Providers**
2. Add your LLM provider (e.g., OpenRouter, OpenAI, Anthropic)
3. Enter your API key and save
4. Go to Configs section
5. Create a new config (e.g., "My Assistant")
6. Add a variant with your preferred model settings
7. Note the config ID for API calls
...
- Configure providers in the dashboard under Settings → Workspace Providers
