...
<iframe width="560" height="315" src="https://www.youtube.com/embed/vnjfShDWuPU?si=NtRRSaHhd6Je2sIJ" title="Create your first LLMOps config" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin"></iframe>
