...
- Configure providers via the `providers` array in code or by setting provider API key environment variables
- Provider API keys are passed directly to the gateway at runtime
