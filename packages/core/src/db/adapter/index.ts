...
export interface DBAdapterFactoryConfig<
  Options extends LLMOpsConfig = LLMOpsConfig,
> {
  /**
...
export type DBTransactionAdapter<Options extends LLMOpsConfig = LLMOpsConfig> =
...
export interface DBAdapterInstance<
  Options extends LLMOpsConfig = LLMOpsConfig,
> {
  (options: LLMOpsConfig): DBAdapter<Options>;
}
