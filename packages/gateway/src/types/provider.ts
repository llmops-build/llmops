/**
 * Resolved configuration for a single provider target: credentials + routing
 * fields. Built per-request from the `@provider/model` slug and the inline
 * provider config. Provider-specific fields are flat and optional.
 */
